...
let gap = Number(tag.getAttribute('space-between'));
let blockWidth = Number(document.querySelector('swiper-slide').clientWidth);
let k = (screenWidth + gap) / (blockWidth + gap);
tag.setAttribute('slides-per-view', k);